...
// Admin and PM for deletion (service layer handles authorization)
router.delete('/:id', validateUUID('id'), restrictTo(ROLES.ADMIN, ROLES.PROJECT_MANAGER), ProjectController.delete);
