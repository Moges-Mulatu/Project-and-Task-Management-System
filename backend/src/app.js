...
app.use(helmet());
app.use(cors({
    origin: ['http://localhost:3000', 'http://localhost:5173', 'http://localhost:5174', 'http://localhost:5175', 'http://localhost:5176', 'http://127.0.0.1:5173', 'http://127.0.0.1:5174', 'http://127.0.0.1:5175', 'http://127.0.0.1:5176', 'http://10.0.2.2:5000'],
    credentials: true
}));
...
function redactSensitiveFields(obj) {
    const sensitive = ['password', 'token', 'accessToken', 'refreshToken', 'secret', 'jwt'];
